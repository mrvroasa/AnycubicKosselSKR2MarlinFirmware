...
#define CUSTOM_MACHINE_NAME "Shinryu"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_SMOOTH_ROD_OFFSET 185.0   // (mm)
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 600, 200 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 4000, 4000 } // ...or, set your own edit limits
#endif
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { -3.7, 2.15, -17.0 }
...
#define Z_PROBE_FEEDRATE_FAST (35*60)
...
#define HOMING_FEEDRATE_MM_M { 0, 0, (35*60) }
...
//#define RGBW_LED
  ...
  //#define RGB_LED_G_PIN 255
  //#define RGB_LED_B_PIN 255
